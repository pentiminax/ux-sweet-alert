...
use Pentiminax\UX\SweetAlert\Twig\Extension\ToastExtension;
...
class SweetAlertBundle extends AbstractBundle
{
    public function loadExtension(array $config, ContainerConfigurator $container, ContainerBuilder $builder): void
    {
        ...
        $container->services()
            ->set('sweet_alert.twig_extension', ToastExtension::class)
            ->arg(0, new Reference('twig'))
            ->arg(1, new Reference('sweet_alert.toast_manager'))
            ->tag('twig.extension')
            ->private();
    }
